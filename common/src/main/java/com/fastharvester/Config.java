...
public class Config {
    ...
    /**
     * How should frames rotate? Pick your favorite dance move.
     */
    public RotationMode rotationMode = RotationMode.FOLLOW_HARVEST_SPIRAL;

    /**
     * How much seed clutter can you handle? (Hint: "NONE" is for neat freaks.)
     */
    public SeedClutterMode seedClutterMode = SeedClutterMode.REDUCED;

    /**
     * How many seeds should we keep in reserve per type? Because running out is embarrassing.
     */
    public int seedReservePerType = 80;

    /**
     * Should we show harvest particles? True for extra sparkle!
     */
