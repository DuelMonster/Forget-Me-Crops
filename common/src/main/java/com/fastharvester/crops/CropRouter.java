...
public class CropRouter {
    ...
    public static boolean routeCrop(Object cropType, Object cropPos, Object world) {
        com.fastharvester.Constants.logInfo("[ROUTER] Routing crop type '{}' at {}...", cropType, cropPos);
        if ("nether_wart".equals(cropType)) {
            ...
            com.fastharvester.Constants.logInfo("[ROUTER] No handler for crop type '{}'. Skipping.", cropType);
            return false;
        }
    }
}
